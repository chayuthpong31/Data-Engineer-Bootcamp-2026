...
INSERT INTO job_postings_fact (
    ...
    job_schedule_type,job_work_from_home,search_location,job_posted_date,job_no_degree_mention,
...
UNION ALL
SELECT 'Skills Dim' AS table_name, COUNT(*) AS record_count FROM skills_dim
UNION ALL
SELECT 'Job Posting Fact' AS table_name, COUNT(*) AS record_count FROM job_postings_fact
UNION ALL
SELECT 'Skills Job Dim' AS table_name, COUNT(*) AS record_count FROM skills_job_dim;
...
SELECT '===== Skills Jobs Dimension Sample =====' AS info;
