-- Step 4: Mart - Creat skills demand mart
...
SELECT '==== Loading Skills Dimension for Skill Mart ====' AS info;
...
SELECT DISTINCT
    ...
    'Q-' || EXTRACT(QUARTER FROM job_posted_date)::VARCHAR AS quater_name,
...
SELECT 'Skill Dimension' AS table_name, COUNT(*) FROM skills_mart.dim_skills
UNION ALL
